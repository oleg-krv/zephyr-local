...
static int gsm_init(struct device *device) {
	...
	k_delayed_work_init(&modem_pins.workers.modem_power_on_work,
						modem_power_on_work);
	k_delayed_work_init(&modem_pins.workers.modem_power_off_work,
...
void z_impl_modem_power_on(void) {
	(void) k_delayed_work_submit(&modem_pins.workers.modem_power_on_work,
								 K_NO_WAIT);
}
 ...
 void z_impl_modem_always_online(bool enable) {
