...
static int lsm6ds3_spi_read(struct lsm6ds3_data *data, uint8_t reg_addr,
...
static int lsm6ds3_spi_write(struct lsm6ds3_data *data, uint8_t reg_addr,
			     uint8_t *value, uint8_t len)
{
	const struct lsm6ds3_config *cfg = data->dev->config;
	const struct spi_config *spi_cfg = &cfg->spi_conf;
...
int lsm6ds3_spi_init(const struct device *dev)
{
	...
	data->ctx_spi.read_reg = (stmdev_read_ptr) lsm6ds3_spi_read,
	data->ctx_spi.write_reg = (stmdev_write_ptr) lsm6ds3_spi_write,
